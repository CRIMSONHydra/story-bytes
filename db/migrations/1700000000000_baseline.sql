-- Up Migration
-- Baseline: reproduces db/schema.sql (all IF NOT EXISTS — safe no-op on existing databases).
-- Legacy numbered migrations 001-007 are preserved in db/legacy-migrations/ for history.
...
-- Down Migration
-- Irreversible baseline; no down migration.
